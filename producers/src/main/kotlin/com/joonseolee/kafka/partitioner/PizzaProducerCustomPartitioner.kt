...
import com.joonseolee.kafka.KafkaConnector
import com.joonseolee.kafka.PizzaMessage
import com.joonseolee.kafka.TestCallback
...
class PizzaProducerCustomPartitioner : TestCallback {

    override fun execute(message: String) {
        val topicName = "pizza-topic-partitioner"
        val kafkaProducer = KafkaConnector.generateKafkaProducer {
            ...
            it.setProperty(
                ...
                CustomPartitioner::class.java.name
            )
            /** custom attributes */
            it.setProperty(
                "custom.specialKey",
